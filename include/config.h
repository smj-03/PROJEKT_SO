...
// PLATFORM
#define PLATFORM_CLOSE_AFTER 20

// PASSENGER
#define PASSENGER_MIN_INTERVAL 6
#define PASSENGER_MAX_INTERVAL 8
#define PASSENGER_SOLO_PROB 3 // 66%
#define PASSENGER_MAX_CONCURRENCY 3
...
#define TRAIN_P_LIMIT 8 // P
#define TRAIN_B_LIMIT 4  // R
#define TRAIN_MAX_CAPACITY 15
#define TRAIN_MIN_RETURN_INTERVAL 10
#define TRAIN_MAX_RETURN_INTERVAL 20
