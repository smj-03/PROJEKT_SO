...
// TRAIN
#define TRAIN_NUM 5 // N
#define TRAIN_DEPART_TIME 5 // T
#define TRAIN_P_LIMIT 100 // P
#define TRAIN_B_LIMIT 50  // R
#define TRAIN_MIN_RETURN_INTERVAL 5
#define TRAIN_MAX_RETURN_INTERVAL 5

// TRAIN DOORS IPC
#define SEM_TRAIN_DOOR_NUM 2
#define SEM_TRAIN_DOOR_KEY 0x00000001 // PRODUCER SEMAPHORE
